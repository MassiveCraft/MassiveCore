 ...
 * vice-versa.
 *
 * <p>The primary class to use is {@link com.massivecraft.mcore.xlib.gson.Gson} which can be constructed with
 * {@code new Gson()} (using default settings) or by using {@link com.massivecraft.mcore.xlib.gson.GsonBuilder}
