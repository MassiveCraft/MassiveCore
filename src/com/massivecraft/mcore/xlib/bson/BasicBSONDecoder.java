...
public class BasicBSONDecoder implements BSONDecoder {
    ...
    protected class BSONInput {
        ...
        public int readInt()
                throws IOException {
            return com.massivecraft.mcore.xlib.bson.io.Bits.readInt( _inputBuffer , _need(4) );
        }

        public int readIntBE()
                throws IOException {
            return com.massivecraft.mcore.xlib.bson.io.Bits.readIntBE( _inputBuffer , _need(4) );
        }

        public long readLong()
                throws IOException {
            return com.massivecraft.mcore.xlib.bson.io.Bits.readLong( _inputBuffer , _need(8) );
        }
