...
public class PoolOutputBuffer extends OutputBuffer {
    ...
    private static com.massivecraft.mcore.xlib.bson.util.SimplePool<byte[]> _extra =
        new com.massivecraft.mcore.xlib.bson.util.SimplePool<byte[]>( ( 1024 * 1024 * 10 ) / BUF_SIZE ){
