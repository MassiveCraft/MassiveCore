...
import com.massivecraft.mcore4.xlib.mongodb.util.Util;
...
public abstract class DB {
     ...
     * This method calls {@link DB#command(com.massivecraft.mcore4.xlib.mongodb.DBObject, int) } with 0 as query option.
    ...
    /**
     * Executes a database command.
     * This method constructs a simple dbobject and calls {@link DB#command(com.massivecraft.mcore4.xlib.mongodb.DBObject) }
     * @see <a href="http://mongodb.onconfluence.com/display/DOCS/List+of+Database+Commands">List of Commands</a>
    ...
    /**
     * Executes a database command.
     * This method constructs a simple dbobject and calls {@link DB#command(com.massivecraft.mcore4.xlib.mongodb.DBObject, int)  }
     * @see <a href="http://mongodb.onconfluence.com/display/DOCS/List+of+Database+Commands">List of Commands</a>
     * @param cmd command to execute
     * @param options query options to use
     * @return result of command from the database
     ...
     * @throws MongoException
     */
    public CommandResult getLastError( com.massivecraft.mcore4.xlib.mongodb.WriteConcern concern )
        throws MongoException {
        return command( concern.getCommand() );
    }

    /**
     * @see {@link DB#getLastError(com.massivecraft.mcore4.xlib.mongodb.WriteConcern) }
     * @param w
     * @param wtimeout
     * @param fsync
     * @return The command result
    ...
    public CommandResult getLastError( int w , int wtimeout , boolean fsync )
        throws MongoException {
        return command( (new com.massivecraft.mcore4.xlib.mongodb.WriteConcern( w, wtimeout , fsync )).getCommand() );
    }
     ...
     */
    public void setWriteConcern( com.massivecraft.mcore4.xlib.mongodb.WriteConcern concern ){
     ...
     * @return
     */
    public com.massivecraft.mcore4.xlib.mongodb.WriteConcern getWriteConcern(){
        if ( _concern != null )
            return _concern;
    ...
    */
    ...
    private com.massivecraft.mcore4.xlib.mongodb.WriteConcern _concern;
    private com.massivecraft.mcore4.xlib.mongodb.ReadPreference _readPref;
