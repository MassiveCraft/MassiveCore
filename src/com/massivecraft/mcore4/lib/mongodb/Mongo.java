...
public class Mongo {
    ...
    /**
     * Creates a Mongo instance based on a (single) mongodb node
     * @see com.massivecraft.mcore4.lib.mongodb.ServerAddress
     * @param addr the database address
     * @throws MongoException
     */
    ...
    com.massivecraft.mcore4.lib.bson.util.SimplePool<PoolOutputBuffer> _bufferPool =
        new com.massivecraft.mcore4.lib.bson.util.SimplePool<PoolOutputBuffer>( 1000 ){
