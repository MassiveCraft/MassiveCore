...
import com.massivecraft.mcore3.lib.mongodb.MongoException;
...
public class GridFSInputFile extends GridFSFile {
    ...
    /**
     * @see com.massivecraft.mcore3.lib.mongodb.gridfs.GridFSInputFile#saveChunks(long)
     *
    ...
    static SimplePool<MessageDigest> _md5Pool
         ...
         * {@inheritDoc}
         *
         * @see com.massivecraft.mcore3.lib.mongodb.util.SimplePool#createNew()
         */
