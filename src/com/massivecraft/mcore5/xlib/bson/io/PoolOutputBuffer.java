...
package com.massivecraft.mcore5.xlib.bson.io;
...
public class PoolOutputBuffer extends OutputBuffer {
    ...
    private static com.massivecraft.mcore5.xlib.bson.util.SimplePool<byte[]> _extra =
        new com.massivecraft.mcore5.xlib.bson.util.SimplePool<byte[]>( ( 1024 * 1024 * 10 ) / BUF_SIZE ){
