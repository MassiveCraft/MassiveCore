...
public class Mongo {
    ...
    /**
     * Creates a Mongo instance based on a (single) mongodb node
     * @see com.massivecraft.massivecore.xlib.mongodb.ServerAddress
     ...
     *             and corresponding {@link com.massivecraft.massivecore.xlib.mongodb.MongoClient#getMongoClientOptions()}
     * @return A {@link com.massivecraft.massivecore.xlib.mongodb.MongoOptions} containing the settings for this MongoDB instance.
     */
    @Deprecated
    ...
    com.massivecraft.massivecore.xlib.bson.util.SimplePool<PoolOutputBuffer> _bufferPool =
        new com.massivecraft.massivecore.xlib.bson.util.SimplePool<PoolOutputBuffer>( 1000 ){
