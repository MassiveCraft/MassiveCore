...
public abstract class DBCollection {
    ...
    /**
     * Modify an existing document or documents in collection. By default the method updates a single document. The query parameter employs
     * the same query selectors, as used in {@link DBCollection#find(DBObject)}.  Calls {@link DBCollection#update(com.massivecraft.massivecore.xlib.mongodb.DBObject,
     * com.massivecraft.massivecore.xlib.mongodb.DBObject, boolean, boolean, com.massivecraft.massivecore.xlib.mongodb.WriteConcern)} with default WriteConcern.
     *
     * @param q      the selection criteria for the update
     * @param o      the modifications to apply
     * @param upsert when true, inserts a document if no document matches the update query criteria
     ...
     * Modify an existing document or documents in collection. By default the method updates a single document. The query parameter employs
     * the same query selectors, as used in {@link DBCollection#find(DBObject)}.  Calls {@link DBCollection#update(com.massivecraft.massivecore.xlib.mongodb.DBObject,
     * com.massivecraft.massivecore.xlib.mongodb.DBObject, boolean, boolean)} with upsert=false and multi=false
     *
     * @param q the selection criteria for the update
     * @param o the modifications to apply
     * @return the result of the operation
    ...
    /**
     * Modify an existing document or documents in collection. By default the method updates a single document. The query parameter employs
     * the same query selectors, as used in {@link DBCollection#find()}.  Calls {@link DBCollection#update(com.massivecraft.massivecore.xlib.mongodb.DBObject,
     * com.massivecraft.massivecore.xlib.mongodb.DBObject, boolean, boolean)} with upsert=false and multi=true
     *
     * @param q the selection criteria for the update
     * @param o the modifications to apply
     * @return the result of the operation
    ...
    /**
     * Remove documents from a collection. Calls {@link DBCollection#remove(com.massivecraft.massivecore.xlib.mongodb.DBObject, com.massivecraft.massivecore.xlib.mongodb.WriteConcern)} with the
    ...
    /**
     * Calls {@link DBCollection#find(com.massivecraft.massivecore.xlib.mongodb.DBObject, com.massivecraft.massivecore.xlib.mongodb.DBObject, int, int)} and applies the query options
     *
     ...
     * @param options   see {@link com.massivecraft.massivecore.xlib.mongodb.Bytes} QUERYOPTION_*
     * @return the cursor
     * @throws MongoException
     * @mongodb.driver.manual tutorial/query-documents/ Query
     * @deprecated use {@link com.massivecraft.massivecore.xlib.mongodb.DBCursor#skip(int)}, {@link com.massivecraft.massivecore.xlib.mongodb.DBCursor#batchSize(int)} and {@link
     * com.massivecraft.massivecore.xlib.mongodb.DBCursor#setOptions(int)} on the {@code DBCursor} returned from {@link com.massivecraft.massivecore.xlib.mongodb.DBCollection#find(DBObject,
     * DBObject)}
     */
    @Deprecated
     ...
     * @throws MongoException
     * @mongodb.driver.manual tutorial/query-documents/ Query
     * @deprecated use {@link com.massivecraft.massivecore.xlib.mongodb.DBCursor#skip(int)} and {@link com.massivecraft.massivecore.xlib.mongodb.DBCursor#batchSize(int)} on the {@code DBCursor}
     * returned from {@link com.massivecraft.massivecore.xlib.mongodb.DBCollection#find(DBObject, DBObject)}
     */
    @Deprecated
    ...
    /**
     * Atomically modify and return a single document. By default, the returned document does not include the modifications made on the
     * update.  Calls {@link DBCollection#findAndModify(com.massivecraft.massivecore.xlib.mongodb.DBObject, com.massivecraft.massivecore.xlib.mongodb.DBObject, com.massivecraft.massivecore.xlib.mongodb.DBObject, boolean,
     * com.massivecraft.massivecore.xlib.mongodb.DBObject, boolean, boolean)} with fields=null, remove=false, returnNew=false, upsert=false
     *
     * @param query  specifies the selection criteria for the modification
     * @param sort   determines which document the operation will modify if the query selects multiple documents
     * @param update the modifications to apply
     ...
     * Atomically modify and return a single document. By default, the returned document does not include the modifications made on the
     * update.  Calls {@link DBCollection#findAndModify(com.massivecraft.massivecore.xlib.mongodb.DBObject, com.massivecraft.massivecore.xlib.mongodb.DBObject, com.massivecraft.massivecore.xlib.mongodb.DBObject, boolean,
     * com.massivecraft.massivecore.xlib.mongodb.DBObject, boolean, boolean)} with fields=null, sort=null, remove=false, returnNew=false, upsert=false
     *
     * @param query  specifies the selection criteria for the modification
     * @param update the modifications to apply
     * @return the document as it was before the modifications.
    ...
    /**
     * Atomically modify and return a single document. By default, the returned document does not include the modifications made on the
     * update.  Ccalls {@link DBCollection#findAndModify(com.massivecraft.massivecore.xlib.mongodb.DBObject, com.massivecraft.massivecore.xlib.mongodb.DBObject, com.massivecraft.massivecore.xlib.mongodb.DBObject, boolean,
     * com.massivecraft.massivecore.xlib.mongodb.DBObject, boolean, boolean)} with fields=null, sort=null, remove=true, returnNew=false, upsert=false
     *
     * @param query specifies the selection criteria for the modification
    ...
    /**
     * Calls {@link DBCollection#createIndex(com.massivecraft.massivecore.xlib.mongodb.DBObject, com.massivecraft.massivecore.xlib.mongodb.DBObject)} with default index options
     *
     ...
     * @throws MongoException
     * @mongodb.driver.manual /administration/indexes-creation/ Index Creation Tutorials
     * @deprecated use {@link #createIndex(DBObject, com.massivecraft.massivecore.xlib.mongodb.DBObject)} the encoder is not used.
     */
    @Deprecated
    ...
    /**
     * Calls {@link DBCollection#ensureIndex(com.massivecraft.massivecore.xlib.mongodb.DBObject, com.massivecraft.massivecore.xlib.mongodb.DBObject)} with default options
    ...
    /**
     * Calls {@link DBCollection#ensureIndex(com.massivecraft.massivecore.xlib.mongodb.DBObject, java.lang.String, boolean)} with unique=false
     *
    ...
    /**
     * calls {@link DBCollection#apply(com.massivecraft.massivecore.xlib.mongodb.DBObject, boolean)} with ensureID=true
    ...
    /**
     * calls {@link DBCollection#doapply(com.massivecraft.massivecore.xlib.mongodb.DBObject)}, optionally adding an automatic _id field
     ...
     * with the fields from the document.</li> </ul>. Calls {@link DBCollection#save(com.massivecraft.massivecore.xlib.mongodb.DBObject, com.massivecraft.massivecore.xlib.mongodb.WriteConcern)} with
     * default WriteConcern
     *
    ...
    /**
     * Get the count of documents in a collection.  Calls {@link DBCollection#getCount(com.massivecraft.massivecore.xlib.mongodb.DBObject, com.massivecraft.massivecore.xlib.mongodb.DBObject)} with an
    ...
    /**
     * Get the count of documents in a collection. Calls {@link DBCollection#getCount(com.massivecraft.massivecore.xlib.mongodb.DBObject, com.massivecraft.massivecore.xlib.mongodb.DBObject,
     * com.massivecraft.massivecore.xlib.mongodb.ReadPreference)} with empty query and null fields.
     *
     * @param readPrefs {@link ReadPreference} to be used for this operation
     * @return the number of documents that matches selection criteria
     * @throws MongoException
    ...
    /**
     * Get the count of documents in collection that would match a criteria. Calls {@link DBCollection#getCount(com.massivecraft.massivecore.xlib.mongodb.DBObject,
     * com.massivecraft.massivecore.xlib.mongodb.DBObject)} with null fields.
     *
     * @param query specifies the selection criteria
     * @return the number of documents that matches selection criteria
     * @throws MongoException
    ...
    /**
     * Get the count of documents in collection that would match a criteria. Calls {@link DBCollection#getCount(com.massivecraft.massivecore.xlib.mongodb.DBObject,
     * com.massivecraft.massivecore.xlib.mongodb.DBObject, long, long)} with limit=0 and skip=0
     *
     * @param query  specifies the selection criteria
    ...
    /**
     * Get the count of documents in collection that would match a criteria.  Calls {@link DBCollection#getCount(com.massivecraft.massivecore.xlib.mongodb.DBObject,
     * com.massivecraft.massivecore.xlib.mongodb.DBObject, long, long, com.massivecraft.massivecore.xlib.mongodb.ReadPreference)} with limit=0 and skip=0
     *
     * @param query     specifies the selection criteria
     * @param fields    this is ignored
     * @param readPrefs {@link ReadPreference} to be used for this operation
    ...
    /**
     * Get the count of documents in collection that would match a criteria.  Calls {@link DBCollection#getCount(com.massivecraft.massivecore.xlib.mongodb.DBObject,
     * com.massivecraft.massivecore.xlib.mongodb.DBObject, long, long, com.massivecraft.massivecore.xlib.mongodb.ReadPreference)} with the DBCollection's ReadPreference
     *
     * @param query          specifies the selection criteria
     * @param fields     this is ignored
     ...
     * This is analogous to a {@code SELECT ... GROUP BY} statement in SQL. Calls {@link DBCollection#group(com.massivecraft.massivecore.xlib.mongodb.DBObject,
     * com.massivecraft.massivecore.xlib.mongodb.DBObject, com.massivecraft.massivecore.xlib.mongodb.DBObject, java.lang.String, java.lang.String)} with finalize=null
     *
     ...
     * @throws MongoException
     * @mongodb.driver.manual reference/command/group/ Group Command
     * @deprecated use {@link DBCollection#group(com.massivecraft.massivecore.xlib.mongodb.GroupCommand)} instead.  This method will be removed in 3.0
     */
    @Deprecated
     ...
     * @throws MongoException
     * @mongodb.driver.manual core/map-reduce/ Map-Reduce
     * @deprecated Use {@link com.massivecraft.massivecore.xlib.mongodb.DBCollection#mapReduce(MapReduceCommand)} instead
     */
    @Deprecated
     ...
     * @deprecated Use {@link com.massivecraft.massivecore.xlib.mongodb.DBCollection#aggregate(java.util.List)} instead
