...
public abstract class DB {
     ...
     * <p/>
     * Following this call and until {@link com.massivecraft.massivecore.xlib.mongodb.DB#requestDone()} is called,
     ...
     * {@link DB#command(com.massivecraft.massivecore.xlib.mongodb.DBObject, int, com.massivecraft.massivecore.xlib.mongodb.ReadPreference, com.massivecraft.massivecore.xlib.mongodb.DBEncoder) } with the database default read
     * preference.  The only option used by this method was "slave ok", therefore this method has been replaced with
     * {@link com.massivecraft.massivecore.xlib.mongodb.DB#command(DBObject, ReadPreference, DBEncoder)}.
     *
     ...
     * @throws MongoException
     * @mongodb.driver.manual tutorial/use-database-commands Commands
     * @deprecated Use {@link com.massivecraft.massivecore.xlib.mongodb.DB#command(DBObject, ReadPreference, DBEncoder)} instead.  This method will be removed in 3.0.
     */
    @Deprecated
    ...
    /**
     * Executes a database command. This method calls
     * {@link DB#command(com.massivecraft.massivecore.xlib.mongodb.DBObject, int, com.massivecraft.massivecore.xlib.mongodb.ReadPreference, com.massivecraft.massivecore.xlib.mongodb.DBEncoder) } with a default encoder.  The only
     * option used by this method was "slave ok", therefore this method has been replaced
     * with {@link com.massivecraft.massivecore.xlib.mongodb.DB#command(DBObject, ReadPreference)}.
     *
     ...
     * @throws MongoException
     * @mongodb.driver.manual tutorial/use-database-commands Commands
     * @deprecated Use {@link com.massivecraft.massivecore.xlib.mongodb.DB#command(DBObject, ReadPreference)} instead.  This method will be removed in 3.0.
     */
    @Deprecated
     ...
     * com.massivecraft.massivecore.xlib.mongodb.DB#command(DBObject, ReadPreference, DBEncoder)}.
     *
     * @param cmd            A {@code DBObject} representation the command to be executed
     * @param options        The query options to use
     * @param readPreference The {@link ReadPreference} for this command (nodes selection is the biggest part of this)
     ...
     * has been replaced with {@link com.massivecraft.massivecore.xlib.mongodb.DB#command(DBObject, ReadPreference)}.
     *
     * @param cmd     The {@code DBObject} representation the command to be executed
     * @param options The query options to use
     ...
     * preference, use this instead of {@link DB#command(com.massivecraft.massivecore.xlib.mongodb.DBObject, int) }
     *
     * @param cmd            The {@code DBObject} representation the command to be executed
     * @param readPreference Where to execute the command - this will only be applied for a subset of commands
     * @return The result of executing the command, success or failure
    ...
    /**
     * Executes a database command. This method constructs a simple dbobject and calls {@link DB#command(com.massivecraft.massivecore.xlib.mongodb.DBObject) }
     *
    ...
    /**
     * Executes a database command. This method constructs a simple dbobject and calls {@link DB#command(com.massivecraft.massivecore.xlib.mongodb.DBObject, int)  }
     *
     * @param cmd     name of the command to be executed
     * @param options query options to use
     * @return result of the command execution
     * @throws MongoException
     * @mongodb.driver.manual tutorial/use-database-commands Commands
     * @deprecated Use {@link com.massivecraft.massivecore.xlib.mongodb.DB#command(String, ReadPreference)} instead.  This method will be removed in 3.0.
     */
    @Deprecated
    ...
    /**
     * Executes a database command. This method constructs a simple dbobject and calls {@link DB#command(com.massivecraft.massivecore.xlib.mongodb.DBObject, int,
     * com.massivecraft.massivecore.xlib.mongodb.ReadPreference)  }. The only option used by this method was "slave ok", therefore this method has been replaced with
     * {@link com.massivecraft.massivecore.xlib.mongodb.DB#command(DBObject, ReadPreference)}.
     *
    ...
    /**
     * Returns the last error that occurred since start of database or a call to {@link com.massivecraft.massivecore.xlib.mongodb.DB#resetError()} The return object
     * will look like:
     * <pre>
     * {@code
     ...
     * @see com.massivecraft.massivecore.xlib.mongodb.DBCursor#close()
