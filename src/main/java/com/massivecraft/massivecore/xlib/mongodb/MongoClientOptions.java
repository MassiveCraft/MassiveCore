...
public class MongoClientOptions {
    ...
    public static class Builder {
         ...
         * @see com.massivecraft.massivecore.xlib.mongodb.MongoClientOptions#getHeartbeatFrequency()
         * @since 2.12.0
         */
         ...
         * @see com.massivecraft.massivecore.xlib.mongodb.MongoClientOptions#getHeartbeatConnectRetryFrequency()
         * @since 2.12.0
         */
         ...
         * @see com.massivecraft.massivecore.xlib.mongodb.MongoClientOptions#getHeartbeatConnectTimeout()
         * @since 2.12.0
         */
         ...
         * @see com.massivecraft.massivecore.xlib.mongodb.MongoClientOptions#getHeartbeatSocketTimeout()
         * @since 2.12.0
         */
         ...
         * @see com.massivecraft.massivecore.xlib.mongodb.MongoClientOptions#getAcceptableLatencyDifference()
         * @since 2.12.0
         */
         ...
         * @return {@code this}
         * @see com.massivecraft.massivecore.xlib.mongodb.MongoClientOptions#getDescription()
         */
         ...
         * @see com.massivecraft.massivecore.xlib.mongodb.MongoClientOptions#getConnectionsPerHost()
         */
         ...
         * @see com.massivecraft.massivecore.xlib.mongodb.MongoClientOptions#getMaxWaitTime()
         */
         ...
         * @see com.massivecraft.massivecore.xlib.mongodb.MongoClientOptions#getMaxConnectionIdleTime()
         * @since 2.12
         */
         ...
         * @return {@code this}
         * @see com.massivecraft.massivecore.xlib.mongodb.MongoClientOptions#getConnectTimeout()
         */
         ...
         * @return {@code this}
         * @see com.massivecraft.massivecore.xlib.mongodb.MongoClientOptions#getSocketTimeout()
         */
         ...
         * @return {@code this}
         * @see com.massivecraft.massivecore.xlib.mongodb.MongoClientOptions#isSocketKeepAlive()
         */
     ...
     * @see com.massivecraft.massivecore.xlib.mongodb.ReadPreference#primary()
     */
